(function () {
  ...
  var converti_e_valuta = function () {
    ...
    var valuta = function (dom, punteggio) {
    ...
    var converti = function (preview, punteggio) {
      var preview = document.getElementById("render");
      preview.srcdoc = content;
      if (!preview.onload) {
        //preview.addEventListener("onload", function () { 
        preview.onload = function () {
          valuta(preview, punteggio);
        };
        //or
        //preview.addEventListener("DOMContentLoaded", function () {/* code */}, false);
      }
      //console.log(preview);
    };

    var dom, punteggio;
    converti(dom, punteggio);
    //return {tests: tests,punteggio: punteggio};
  }
  ...
  var invia = function () {
    ...
    document.getElementById("punti").value = 0; // 10 * risultato.punteggio.punti / risultato.punteggio.scala;
  ...
  // 1 - Titolo
  creaTest("Titolo",
    "Inserisci il titolo: <code>Verifica di <em>Nome</em> " +
    "<em>Cognome</em>.", 3,
    function (d) {
      //console.log(d);
