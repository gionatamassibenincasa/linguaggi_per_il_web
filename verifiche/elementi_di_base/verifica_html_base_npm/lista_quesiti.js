...
export const lista_quesiti = [
    ...
    { // Andare a capo
        quesito: {
            ...
            descrizione: 'Inserire in un <strong>capoverso</strong> avente <em>id</em> <code>soldati</code> i due blocchi di testo: <code>Si sta come</code>, e <code>d\'autunno</code> separati da un elemento per andare <code>a capo</code>',
            competenza: '',
            punteggio: 1
        },
        specifica: {
    ...
    { // Collegamento
        quesito: {
            ...
            descrizione: 'Inserire un <stong>collegamento</strong> che punti all\'indirizzo <code>http://www.gnu.org/</code> e che mostri il  testo <code>il progetto GNU</code>',
            competenza: '',
            punteggio: 1
        },
        specifica: {
    ...
    { // Immagine
        quesito: {
            ...
            descrizione: 'Inserire un\'<strong>immagine</strong> il cui <em>indirizzo</em> sia <code>http://www.gnu.org/graphics/gnu-head.jpg</code> e il <em>testo alternativo</em> sia <code>la testa di uno gnu</code>',
            competenza: '',
            punteggio: 1
        },
        specifica: {
    ...
    { // Tabella
        quesito: {
            ...
            descrizione: 'Inserire  una <strong>tabella</strong> composta di un\'<strong>intestazione</strong> e di un <strong>corpo</strong>; l\'intestazione contiene una riga con la <strong>cella d\'intestazione</strong> dal testo <code>colonna 1</code>; il corpo contiene nella prima riga una <strong>cella</strong> con testo <code>dato 1</code>',
            competenza: '',
            punteggio: 3
        },
        specifica: {
            struttura_per_valutazione: {
                modello: 'DOM', // 'PLAINTEXT', 'DOM', 'CSSDOM', 'ASCIIDOC'
                analisi: 'Contenuto',
                selettore: ['html > body table > thead > tr > th:first-child', 'html > body table > tbody > tr > td:first-child'],
                contenuto: [/^colonna 1$/i, /^dato 1$/i],
                callback: null
            }
        }
    },
    ...
    { // Annidamento
        quesito: {
            ...
            descrizione: 'Creare un elemento <code>div</code> con annidato un elemento <code>p</code> con annidato un elemento <code>span</code>. Il contenuto dell\'ultimo elemento &egrave; <code>span dentro p dentro div</code>',
            competenza: '',
            punteggio: 2
        },
        specifica: {
